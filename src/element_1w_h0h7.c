...
void mul_schoolbook_1w_h0h7(uint64_t *C, uint64_t *A, uint64_t *B)
{
	int i,j;
...
do{                                 \
	...
	r3 = MUL128(s3,t0);             \
                                    \
	r1 = ADD128(r1,MUL128(s0,t1));  \
	r2 = ADD128(r2,MUL128(s1,t1));  \
	r3 = ADD128(r3,MUL128(s2,t1));  \
	r4 =           MUL128(s3,t1);   \
	                                \
	r2 = ADD128(r2,MUL128(s0,t2));  \
	r3 = ADD128(r3,MUL128(s1,t2));  \
	r4 = ADD128(r4,MUL128(s2,t2));  \
	r5 =           MUL128(s3,t2);   \
	                                \
	r3 = ADD128(r3,MUL128(s0,t3));  \
	r4 = ADD128(r4,MUL128(s1,t3));  \
	r5 = ADD128(r5,MUL128(s2,t3));  \
	r6 =           MUL128(s3,t3);   \
	                                \
}while(0)
...
do{                                                                               \
	...
	__m128i sF0 = ADD128(f0,SHUF128(f0,0x4E)); __m128i sG0 = ADD128(g0,SHUF128(g0,0x4E)); \
	__m128i sF1 = ADD128(f1,SHUF128(f1,0x4E)); __m128i sG1 = ADD128(g1,SHUF128(g1,0x4E)); \
	__m128i sF2 = ADD128(f2,SHUF128(f2,0x4E)); __m128i sG2 = ADD128(g2,SHUF128(g2,0x4E)); \
	__m128i sF3 = ADD128(f3,SHUF128(f3,0x4E)); __m128i sG3 = ADD128(g3,SHUF128(g3,0x4E)); \
                                                                                  \
	mul_school_4x4(q0,q1,q2,q3,q4,q5,q6,                                          \
				  sF0,sF1,sF2,sF3,                                                \
				  sG0,sG1,sG2,sG3);                                               \
...
void mul_karatsuba_1w_h0h7(uint64_t *  C, uint64_t * A, uint64_t *  B)
{
	...
	__m128i b0b7,b1b8,b2b9,b3b10,b4b11,b5b12,b6b13;
	...
	a0a7  = LOAD128(A+0);   b0b7  = LOAD128(B+0);
	a1a8  = LOAD128(A+1);   b1b8  = LOAD128(B+1);
	a2a9  = LOAD128(A+2);   b2b9  = LOAD128(B+2);
	a3a10 = LOAD128(A+3);   b3b10 = LOAD128(B+3);
	a4a11 = LOAD128(A+4);   b4b11 = LOAD128(B+4);
	a5a12 = LOAD128(A+5);   b5b12 = LOAD128(B+5);
	a6a13 = LOAD128(A+6);   b6b13 = LOAD128(B+6);
	...
	__m128i sA0_4 = ADD128(UPKL64128(a0a7,a4a11),UPKH64128(a0a7,a4a11)); __m128i sB0_4 = ADD128(UPKL64128(b0b7,b4b11),UPKH64128(b0b7,b4b11));
	__m128i sA1_5 = ADD128(UPKL64128(a1a8,a5a12),UPKH64128(a1a8,a5a12)); __m128i sB1_5 = ADD128(UPKL64128(b1b8,b5b12),UPKH64128(b1b8,b5b12));
	__m128i sA2_6 = ADD128(UPKL64128(a2a9,a6a13),UPKH64128(a2a9,a6a13)); __m128i sB2_6 = ADD128(UPKL64128(b2b9,b6b13),UPKH64128(b2b9,b6b13));
	__m128i sA3_7 = ADD128(UPKL64128(a3a10,ZERO128),UPKH64128(a3a10,ZERO128)); __m128i sB3_7 = ADD128(UPKL64128(b3b10,ZERO128),UPKH64128(b3b10,ZERO128));
...
{
	mul_karatsuba_1w_h0h7(pC, pA, pB);
//	mul_schoolbook_1w_h0h7(pC, pA, pB);
}
